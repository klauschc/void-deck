    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 20) {
                ...
                NavigationLink("繼續", value: "cards").buttonStyle(.borderedProminent).tint(TarotTheme.primaryStart).disabled(questionText.trimmingCharacters(in: .whitespaces).isEmpty)
